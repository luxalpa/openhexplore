...
//inline auto loadPCXFile = (int (*const)(char *, int, int, int, int)) 0x401000;
...
inline auto sub_415900 = (int (*const)(int*)) 0x415900;
inline auto sub_4168D0 = (int (*const)(char*)) 0x4168D0;
