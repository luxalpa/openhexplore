...
int32_t DISABLE_OPT HEXP_CALLPROC_X(int32_t address, int32_t _eax, int32_t _ebx, int32_t _ecx, int32_t _edx, int32_t _esi, int32_t _edi, int32_t _ebp)
{
    int32_t result = 0;
...
int32_t DISABLE_OPT HEXP_CALLFUNC_X(int32_t address, int32_t *_eax, int32_t *_ebx, int32_t *_ecx, int32_t *_edx, int32_t *_esi, int32_t *_edi, int32_t *_ebp)
{
    int32_t result = 0;
    _originalAddress = address;
#if defined(PLATFORM_X86)
...
{
    return HEXP_CALLPROC_X(address, registers());
}

int32_t HEXP_CALLFUNC_X(int32_t address, registers &registers)
{
    return HEXP_CALLFUNC_X(
        address,
        &registers.eax,
        &registers.ebx,
        &registers.ecx,
